...
/**
 * The master-controller is what ties the program together. All communication will be done-
 * via the master-controller in some way or form.
 * It is also responsible for switching between different scenes and transfering references-
 * between different scenes so no information is lost to the bin collector.
 */
