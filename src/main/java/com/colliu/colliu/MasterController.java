...
// Write comment here
  ...
  public void filterEvents(){
    ...
    if(cb1.isSelected()){
      masterController.filterEvents(cb1.getText());
    }
    if(cb2.isSelected()){
      masterController.filterEvents(cb2.getText());
    }
    if(cb3.isSelected()) {
      masterController.filterEvents(cb3.getText());
    }
    if(cb4.isSelected()) {
      masterController.filterEvents(cb4.getText());
    }
    if(cb5.isSelected()) {
      masterController.filterEvents(cb5.getText());
    }
    if(cb6.isSelected()) {
      masterController.filterEvents(cb6.getText());
    }
    if(cb7.isSelected()) {
      masterController.filterEvents(cb7.getText());
    }
    if(cb8.isSelected()) {
      masterController.filterEvents(cb8.getText());
    }
    if(cb9.isSelected()) {
      masterController.filterEvents(cb9.getText());
    }
  }
